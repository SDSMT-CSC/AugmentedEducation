 ...
 \section{File Conversion}
    ...
    The goal for the file type research was to find out what the common 3D model file types are, and what is commonly used with AR devices.  Another goal was to determine a common file type for all file types on the website.
