...
\chapter{Sprint Schedule and Prototypes}    
    ...
    \includepdf[pages={1}]{SpringSprintSchedule.pdf}\label{section:SpringSprintSchedule}
    \includepdf[pages={2-4}]{SpringSprintSchedule.pdf}
    \newpage
    \section{Senior Design II Final Designs}
    \input{Sprint_Reports_And_Prototypes/Prototypes/FinalDesigns.tex}
