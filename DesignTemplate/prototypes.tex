...
\chapter{Sprint Results and Prototypes}    
    ...
    %% Definitely need to add something more about file type research
    %% Will pair up with one of Aaron, Ken, Cheldon to figure out where to add that

    %% Also need to document something about discovery of Hololens rendering limitations
    %% Probably list that in the sprint 4 reportsince it's before the 2nd presentation and it's the shortest report
    \newpage
    \input{Sprint_Reports_And_Prototypes/Sprint_Reports/Sprint0}
    \newpage
    \input{Sprint_Reports_And_Prototypes/Sprint_Reports/Sprint1}
    \newpage
    \input{Sprint_Reports_And_Prototypes/Sprint_Reports/Sprint2}
    \newpage
    \input{Sprint_Reports_And_Prototypes/Sprint_Reports/Sprint3}
    \newpage
    \input{Sprint_Reports_And_Prototypes/Sprint_Reports/Sprint4}
    \newpage
    \input{Sprint_Reports_And_Prototypes/Sprint_Reports/Sprint5}


    \newpage
    \section{Prototypes}
    \input{Sprint_Reports_And_Prototypes/Prototypes/Prototypes.tex}