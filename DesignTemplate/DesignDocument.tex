...
% Macro set up to add the Software agreement to the end and number the pages separately from the document.  Don't want to do a standard chapter heading, but do want it to appear in the table of contents and in the index used for on-line viewing.
\agreement
...
% \input{hardwareexploration.tex}   %% Research track  only
