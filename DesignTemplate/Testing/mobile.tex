...
\section{Mobile Testing}
    ...
    \subsection{QR Code Scanning}
        ...
        While we weren't able to test QR codes that pointed to our 3D model downloads during development, we knew that it was just a matter of encoding the link in the QR code correctly. With this in mind, we continued to test on random QR codes. Once we had the functionality to embed the download link in a QR code, we tested downloading a number of files manually using their respective QR codes.
