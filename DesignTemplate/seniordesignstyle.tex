...
\graphicspath{{Graphics/}, {Graphics/Deployment/}}
\usepackage{amsmath}
\usepackage{amsthm}
\usepackage{amssymb}
%\usepackage{txfonts}
...
\makeatletter% Need the '@' letter to call if@openright
...
%% {\titlerule[2pt]}]
  ...
  %%% Redefine \chapter to explicitly reset the page number
  %%%  (comment out to see effect)
  \renewcommand{\chapter}[1]{
    \stdchapter{##1}\setcounter{page}{1}
    %%% Also redefined page numbering
