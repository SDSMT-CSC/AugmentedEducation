...
\label{sec:Sprint0_report}
    ...
    \label{sec:Sprint0_successes}
        ...
        \hspace{7mm}The decision was between using Azure cloud services or Amazon Web Services. The development team voted to use Azure on the grounds that staying within the Microsoft development network would ensure compatibility with our primary target device, the Microsoft HoloLens, and ease development.
