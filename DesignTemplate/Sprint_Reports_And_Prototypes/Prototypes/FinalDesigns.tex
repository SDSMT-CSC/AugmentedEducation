...
\subsection{Public Content}
    ...
    \begin{figure}[H]
        \centering \includegraphics[width=0.6\linewidth]{PublicContentFinal}
...
\subsection{Upload Page}
    ...
    \begin{figure}[H]
        \centering \includegraphics[width=0.6\linewidth]{UploadFinal}
...
\subsection{My Content}
    ...
    \begin{figure}[H]
        \centering \includegraphics[width=0.6\linewidth]{MyContentFinal}
...
\subsection{Help Page}
    ...
    \begin{figure}[H]
        \centering \includegraphics[width=0.6\linewidth]{HelpFinal}
