...
% We manage our backlog using GitHub's project board. The board has three other 
% sections: 'Work in Progress', 'QA', and 'Ready'. Using GitHub's system is 
% convenient as we also use it to host our code repository. 
...
% If required, we can provide this 
