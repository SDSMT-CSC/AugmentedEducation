...
\begin{itemize}
	\item Users may use the website interface to upload files from a CAD programs commonly used in STEM education. 
...
\begin{itemize}
	\item Expand platform to support broad range of file types for the purpose of increasing number of CAD programs supported. 
