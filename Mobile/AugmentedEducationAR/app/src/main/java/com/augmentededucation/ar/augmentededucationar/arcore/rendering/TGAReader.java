...
//		int originY = (buffer[10] & 0xFF) | (buffer[11] & 0xFF) << 8; // unsupported
    ...
    private static int[] createPixelsFromColormap(int width, int height, int depth, byte[] bytes, int offset,
                                                  byte[] palette, int colormapOrigin, int descriptor, Order order) throws IOException {
        int[] pixels = null;
    ...
    private static int[] createPixelsFromRGB(int width, int height, int depth, byte[] bytes, int offset, int descriptor,
    ...
    private static int[] createPixelsFromGrayscale(int width, int height, int depth, byte[] bytes, int offset,
                                                   int descriptor, Order order) throws IOException {
        int[] pixels = null;
        int rs = order.redShift;
        int gs = order.greenShift;
        int bs = order.blueShift;
