 ...
 * {@link CameraSource.Builder#setRequestedFps(float)} specifies a frame rate that works well with
 * the capabilities of the camera hardware and the detector options that selected.  If CPU
 * utilization is higher than preferred, FPS can be reduced.  If the camera preview or detector
 * results are too "jerky", increase FPS.
 * <p/>
...
public class CameraSource {
    ...
    private byte[] createPreviewBuffer(Size previewSize) {
        ...
        if (!buffer.hasArray() || (buffer.array() != byteArray)) {
            // Unlikely that this would ever happen.  But if it does, then we wouldn't be
